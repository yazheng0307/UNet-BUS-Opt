...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate the cached-pretrained ResNet50 U-Net")
    parser.add_argument("--model_path", default="./runs/resnet50_unet_split3/best_model.pth")
    ...
    parser.add_argument("--output_dir", default="./runs/resnet50_unet_split3/evaluation")
...
def main():
    ...
    model = ResNet50UNet(checkpoint_path=args.encoder_checkpoint).to(device)
